...
11. **Commit** as `{ID}: <title>`, e.g. `R01: Worker service + BullMQ report consumer`.
    Include the `.agents/ledgers/report/` and `.agents/devlogs/` file changes in the same commit.
