...
// who gives up actually stops, and 255 interviews were stranded in it — more than every other
// sweepable state put together. The sweep ends them at `abandoned` rather than routing a
// partial run through `evaluating` the way the leave button does: these rows have been
// untouched for a day, and spending a provider call on a report nobody asked for is not what
// "clean up after a candidate who never came back" should mean.
